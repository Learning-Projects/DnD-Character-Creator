...
\begin{enumerate}
	...
	\item \textbf{Storing characters:} The user will be able to store characters that they have created or modified in a local file on their system so that the character details can be loaded in future.
	\item \textbf{Loading characters:} The user will be able to load a previously created character from a local file. Previously loaded profiles will be listed under a "Recently accessed" window.
